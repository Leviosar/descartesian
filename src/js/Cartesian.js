...
var Cartesian = /** @class */ (function () {
    ...
    Cartesian.prototype.setup = function () {
        var _this = this;
    ...
    Cartesian.prototype.build = function () {
        this.render = new p5(this.sketch);
    };
    Cartesian.prototype.buildGrid = function (p) {
    ...
    Cartesian.prototype.clicked = function (ev) {
    ...
    Cartesian.prototype.guideLines = function (p) {
        p.stroke('#aaa');
    ...
    Cartesian.prototype.renderFunction = function (p, f) {
        if (f != null) {
            var halfWidth = p.width / 2;
            var halfHeight = p.height / 2;
